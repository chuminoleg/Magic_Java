...
public class ComparatorInterface {
    ...
    public static void main(String[] args) {
        ...
        Collections.sort(birds, new ComparatorByStringLength()); // статический метод sort
        System.out.println(birds);
        ...
        Collections.sort(numbers, new ComparatorReversedInteger()); // статический метод sort
        System.out.println(numbers);
